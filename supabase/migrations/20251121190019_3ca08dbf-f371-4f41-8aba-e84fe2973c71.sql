-- ============================================================================
-- MIGRACIÓN: Agregar business_type y función seed para onboarding
-- ============================================================================
-- Agrega el campo business_type a companies y crea función RPC para 
-- generar datos iniciales (categorías, productos, áreas, mesas) según 
-- el tipo de negocio seleccionado por el usuario.
-- ============================================================================

-- PASO 1: Agregar campo business_type a companies
-- ============================================================================
DO $$ 
BEGIN
...
ADD COLUMN IF NOT EXISTS business_type public.business_type DEFAULT 'other';

-- PASO 2: Crear función para seed de datos según tipo de negocio
-- ============================================================================
...
BEGIN
  ...
  CASE _business_type
    ...
    WHEN 'restaurant' THEN
      ...
      RETURNING ARRAY_AGG(id) INTO category_ids;
      ...
      RETURNING ARRAY_AGG(id) INTO area_ids;
...
-- 1. Campo business_type a companies (enum con tipos de negocio)
-- 2. Función RPC seed_default_data_for_business_type que:
--    - Verifica si ya existe seed para evitar duplicados
--    - Inserta categorías, productos, áreas y mesas según el tipo de negocio
--    - Retorna JSON con resultado y estadísticas
--
-- Uso en frontend:
-- await supabase.rpc('seed_default_data_for_business_type', {
